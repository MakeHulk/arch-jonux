...
# The original arch install script from https://github.com/classy-giraffe/easy-arch/tree/main
# I found it to be the best minimal and easy arch install script that just works and is just a single file.
# I still haven't made many changes because, well, time.
...
# Select quick or advanced installation
quick_or_advanced () {
    info_print "Choose how advanced you are:"
    info_print "1) I'm a noob so just make this fast and do all the choices for me."
    info_print "2) I'm an advanced veteran, so let me choose the kernel and stuff."
    input_print "Please select the number of the choice which best describes you (1 or 2): "
    read -r skill_choice
    case $skill_choice in
        1 ) info_print "Noob it is!"
            return 0;;
        2 ) info_print "Oh, you think you pro? tbh this shit still pretty easy, you can just choose 1 on every option."
            return 0;;
        * ) error_print "Ok, you get the noob quick installation because you even messed this up."
            skill_choice=1
            return 0;;
    esac
}
...
# User enters a password for the LUKS Container (function). In the future setting up luks will be a choice
lukspass_selector () {
...
==========================================================================================================
     o      oooooooooo    oooooooo8 ooooo ooooo        ooooo  ooooooo  oooo   oooo ooooo  oooo ooooo  oooo
    888      888    888 o888     88  888   888          888 o888   888o 8888o  88   888    88    888  88
   8  88     888oooo88  888          888ooo888          888 888     888 88 888o88   888    88      888
  8oooo88    888  88o   888o     oo  888   888          888 888o   o888 88   8888   888    88     88 888
o88o  o888o o888o  88o8  888oooo88  o888o o888o         888   88ooo88  o88o    88    888oo88   o88o  o888o
                                                     8o888
==========================================================================================================
${RESET}"
info_print "Welcome to Arch Jonux installation, seems you are quite based, aren't you? After this installation, you will be able to say I use Arch Jonux, btw, which is really sigma and cool."
...
do
    DISK="$ENTRY"
    info_print "Arch Jonux will be installed on the following disk: $DISK"
    break
done

# Ask if the user wants to do a quick installation which works for most users or an advanced one.
until quick_or_advanced; do : ; done
...
info_print "Installing KDE Plasma (this will also take a couple minutes)"
pacstrap -K /mnt plasma &>/dev/null
info_print "Installing essential applications"
pacstrap -K /mnt git base-devel plasma kitty dolphin fastfetch firefox fish &>/dev/null
...
# sed -i "/^#$fi_FI.UTF-8/s/^#//" /mnt/etc/locale.gen
echo "fi_FI.UTF-8 UTF-8" >> /mnt/etc/locale.gen
echo "LANG=fi_FI.UTF-8" > /mnt/etc/locale.conf
...
arch-chroot /mnt /bin/bash -e <<EOF
    ...
    # Setting up timezone.
    ln -sf /usr/share/zoneinfo/Europe/Helsinki /etc/localtime &>/dev/null
    ...
    # Installing paru and brave-browser except this doesn't work because makepkg cannot be run as root
    ...
    # Change the SDDM theme in the configuration except the theme is not done and this is the wrong location prob
    # sed -i "s/^Current=.*/Current=Jonux-Dark/" /etc/sddm.conf.d/kde_settings.conf
...
services=(reflector.timer snapper-timeline.timer snapper-cleanup.timer btrfs-scrub@-.timer btrfs-scrub@home.timer btrfs-scrub@var-log.timer btrfs-scrub@\\x2esnapshots.timer grub-btrfsd.service systemd-oomd sddm)
...
info_print "All done, you will boot into the glorious Arch Jonux"
sleep 5
reboot
exit
